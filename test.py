...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.R1Q1 = tk.Radiobutton(variable=correct, value='TRUE')
        self.R1Q1.grid(row=1, column=3, sticky=tk.E)

        self.lblR2Q1 = tk.Label(self.master, text="False", font=('bold', 14), pady=20)
        self.lblR2Q1.grid(row=0, column=4, sticky=tk.E)
        self.R2Q1 = tk.Radiobutton(variable=correct, value='FALSE')
        self.R2Q1.grid(row=1, column=4, sticky=tk.E)
        # Part
